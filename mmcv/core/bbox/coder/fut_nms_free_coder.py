...
class V2CustomNMSFreeCoder(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds, traj_preds):
        ...
        final_traj_cls_preds = cls_scores[bbox_index]
        ...
        if self.post_center_range is not None:
            ...
            trajs_cls = final_traj_cls_preds[mask]
    ...
    def decode(self, preds_dicts, cls_key='all_cls_scores', bbox_key='all_bbox_preds', traj_key='all_traj_preds'):
        """Decode bboxes.
        Args:
        ...
        Returns:
            list[dict]: Decoded boxes.
        """
        all_cls_scores = preds_dicts[cls_key][-1]
        all_bbox_preds = preds_dicts[bbox_key][-1]
        all_traj_preds = preds_dicts[traj_key][-1]
