...
def parse_args():
    ...
    parser.add_argument('--deepspeed_config', type=str, help='path to deepSpeed config')
...
def main():
    ...
    # handle no_validate exception
    cfg.no_validate = getattr(cfg, 'no_validate', False)  # Set default to False if not specified
    no_validate = args.no_validate or cfg.no_validate
    if no_validate:
        print("Will not validate during training")
    ...
    custom_train_model(
        ...
        validate=(not (args.no_validate or cfg.no_validate)),
        timestamp=timestamp,
        meta=meta)
